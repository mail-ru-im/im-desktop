...
namespace core
{
    ...
    namespace wim
    {
        ...
        public:
            pinned_chat();
            pinned_chat(const std::string& _aimid, friendly _friendly, const int64_t _time);
        ...
        class pinned
        {
            ...
            std::vector<pinned_chat>	contacts_;
        ...
        public:
            ...
            const std::vector<pinned_chat>& contacts() const { return contacts_; }

            pinned();
            virtual ~pinned();

            void update(pinned_chat& _contact);
