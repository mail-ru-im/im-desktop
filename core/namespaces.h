...
#define CORE_MEMORY_STATS_NS memory_stats
#define CORE_MEMORY_STATS_NS_BEGIN CORE_NS_BEGIN namespace CORE_MEMORY_STATS_NS {
#define CORE_MEMORY_STATS_NS_END } CORE_NS_END
