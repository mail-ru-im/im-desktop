...
private:
    ...
    friend class std::numeric_limits<wide_integer<Bits, signed>>;
    friend class std::numeric_limits<wide_integer<Bits, unsigned>>;
...
// Binary operators
template <size_t Bits, typename Signed, size_t Bits2, typename Signed2>
common_type_t<wide_integer<Bits, Signed>, wide_integer<Bits2, Signed2>> constexpr operator*(const wide_integer<Bits, Signed>& lhs, const wide_integer<Bits2, Signed2>& rhs);
template <typename Arithmetic, typename Arithmetic2, class = __only_arithmetic<Arithmetic, Arithmetic2>>
common_type_t<Arithmetic, Arithmetic2> constexpr operator*(const Arithmetic& rhs, const Arithmetic2& lhs);
...
common_type_t<Integral, Integral2> constexpr operator%(const Integral& rhs, const Integral2& lhs);
