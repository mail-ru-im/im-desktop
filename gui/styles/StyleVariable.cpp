    ...
    const StyleVariableStrings& getVariableStrings()
    {
        static const StyleVariableStrings properties = []()
        {
            StyleVariableStrings props =
            {
                ...
                { StyleVariable::BASE_GLOBALWHITE_SECONDARY,       qsl("base_globalwhite_secondary") },
                { StyleVariable::BASE_GLOBALWHITE_PERMANENT,       qsl("base_globalwhite_permanent") },
                { StyleVariable::BASE_GLOBALWHITE_PERMANENT_HOVER, qsl("base_globalwhite_permanent_hover") },
                { StyleVariable::BASE_GLOBALBLACK_PERMANENT,       qsl("base_globalblack_permanent") },
                ...
                { StyleVariable::CHAT_PRIMARY_MEDIA,               qsl("chat_primary_media") },
                { StyleVariable::CHAT_SECONDARY,                   qsl("chat_secondary") },
                { StyleVariable::CHAT_SECONDARY_MEDIA,             qsl("chat_secondary_media") },
                ...
                { StyleVariable::GHOST_PERCEPTIBLE,                qsl("ghost_perceptible") },
                { StyleVariable::LUCENT_TERTIARY,                  qsl("lucent_tertiary") },
                { StyleVariable::LUCENT_TERTIARY_HOVER,            qsl("lucent_tertiary_hover") },
                { StyleVariable::LUCENT_TERTIARY_ACTIVE,           qsl("lucent_tertiary_active") },
                ...
                { StyleVariable::PRIMARY_LIGHT,                    qsl("primary_light") },
                ...
                { StyleVariable::SECONDARY_RAINBOW_WARM,           qsl("secondary_rainbow_warm") },
                ...
                { StyleVariable::SECONDARY_RAINBOW_YELLOW,         qsl("secondary_rainbow_yellow") },
                { StyleVariable::SECONDARY_RAINBOW_EMERALD,        qsl("secondary_rainbow_emerald") },
                { StyleVariable::SECONDARY_RAINBOW_EMERALD_HOVER,  qsl("secondary_rainbow_emerald_hover") },
                { StyleVariable::SECONDARY_RAINBOW_EMERALD_ACTIVE, qsl("secondary_rainbow_emerald_active") },
